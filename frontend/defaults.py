...
_BOOK_URLS_DATE_FORMAT = ""
if getattr(settings, "BOOK_URLS_USE_DATE", False):
    _BOOK_URLS_DATE_FORMAT = "day"
    from warnings import warn
    warn("BOOK_URLS_USE_DATE setting is deprecated, please use the "
        "BOOK_URLS_DATE_FORMAT setting with a value of 'year', 'month', "
        "or 'day'.")

register_setting(
    name="BOOK_URLS_DATE_FORMAT",
    ...
    editable=False,
    default=_BOOK_URLS_DATE_FORMAT,
)
